    ...
    <ContentLayout>
      ...
      <div className="pt-32 pb-24 px-6 md:px-12 lg:px-24">
        <div className="container mx-auto max-w-2xl text-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight mb-2">Failed to load blog posts</h1>
          
          <p className="text-muted-foreground mb-8">
            We couldn't fetch the blog posts. This might be a temporary issue with GitHub's API.
          </p>
